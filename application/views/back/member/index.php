              ...
              <div class="content">
                <div class="overview">
                  <div class="row">
                    ...
                    <div class="cell">
										  <i class="icon-line icon-login" aria-hidden="true"></i>
                  ...
                  <div class="row">
                    <div class="cell">
                      ...
                      <span dir="ltr"><?php echo fanum(number_format($user)); ?></span>
                    </div>
                    <div class="cell">
										  <i class="icon-line icon-user-following" aria-hidden="true"></i>
									  	<span>تعداد مدیران</span>
                      <span dir="ltr"><?php echo fanum(number_format($admin)); ?></span>
                    </div>
                    <div class="cell">
										  <!-- NULL -->
                    </div>
