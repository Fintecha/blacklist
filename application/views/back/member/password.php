                ...
                <?php echo form_open(); ?>
			            ...
			            <div class="form-field">
			              ...
			              <?php echo form_error('confirm', '<span class="wrong">', '</span>'); ?>
					     		...
					     		<div class="form-field">
			              <button id="submit" name="submit" type="submit" title="تغییر" class="button bg-info">
			                <i class="icon-line icon-pencil" aria-hidden="true"></i> تغییر کلمه عبور
			              </button>
						      	<a href="<?php echo base_url('panel'); ?>" target="_self" title="برگشت" class="button bg-danger">
